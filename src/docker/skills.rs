...
// Re-export validate_skill_format from skills::validate for backward compatibility
#[doc(hidden)]
pub use crate::skills::validate::validate_skill_format;

// Re-export extract_skill_name from skills::validate for backward compatibility
#[doc(hidden)]
pub use crate::skills::validate::extract_skill_name;
